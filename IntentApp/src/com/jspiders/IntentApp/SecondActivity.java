package com.jspiders.IntentApp;
...
public class SecondActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(b1.getString("Key3")==null){
			resultTextView.setText("Results after opertaion with "+Double.toString(d1)+" are:");
		...
		divTextView.setText(dToS(d1/5));
			...
			resultTextView.setText("To get the results for operation, please enter a number!");
